...
export const Configuracion = () => {
  ...
  const [empresaForm, setEmpresaForm] = useState({
    company_name: 'Star Inmobiliaria',
    email: 'info@starinmobiliaria.com',
    phone: '+54 9 11 3556-5132',
  ...
  // Sync form state when data loads from Supabase
  useEffect(() => {
    if (companySettings) {
      setEmpresaForm({
        company_name: companySettings.company_name || 'Star Inmobiliaria',
        email: companySettings.email || 'info@starinmobiliaria.com',
        phone: companySettings.phone || '+54 9 11 3556-5132',
        address: companySettings.address || 'Buenos Aires, Argentina',
  ...
  // Sync agent settings from Supabase
  useEffect(() => {
    const empConfig = getAgentConfig('emprendimientos')
    if (empConfig) {
    ...
    <main className="flex-1 flex flex-col overflow-hidden bg-[#F8F9FA] h-full">
      ...
      <div className="flex-shrink-0 px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 bg-white">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {settingsLoading && <Loader2 className="w-4 h-4 animate-spin text-gray-400" />}
        </div>
      </div>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {agentSettings.emprendimientos.active && (
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) => handleAgentToggle('emprendimientos', 'active', e.target.checked)}
                ...
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 text-sm sm:text-base">
                      {empresaForm.company_name || 'Star Inmobiliaria'}
                    </h3>
