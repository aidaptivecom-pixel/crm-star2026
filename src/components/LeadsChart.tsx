...
const CustomTooltip = ({ active, payload, label }: any) => {
  if (active && payload && payload.length) {
    ...
    return (
      <div className="bg-white p-4 border border-gray-100 rounded-lg shadow-xl min-w-[200px]">
  ...
  return (
    <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)]">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          <h2 className="text-lg font-semibold text-gray-900">Leads por Día</h2>
          <p className="text-sm text-gray-500 mt-1">Total vs. Calificados en los últimos 28 días</p>
        </div>
